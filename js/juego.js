...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 325, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 100, 350, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 200, 400, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 200, 430, 30, 30, 1),

    new Obstaculo('imagenes/valla_horizontal.png', 795, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 855, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 765, 200, 30, 30, 1),

    new Obstaculo('imagenes/bache.png', 560, 130, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 560, 70, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 820, 120, 30, 30, 1),

    new Obstaculo('imagenes/auto_verde_abajo.png', 420, 110, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 130, 300, 30, 15, 1)
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',400,400,10,10,2,{desdeX: 400,hastaX: 500,desdeY: 400, hastaY:500}),
    new ZombieCaminante('imagenes/zombie2.png',600,200,10,10,2,{desdeX: 500,hastaX: 800,desdeY: 100, hastaY:150}),
    new ZombieCaminante('imagenes/zombie3.png',780,360,10,10,3,{desdeX: 780,hastaX: 870,desdeY: 360, hastaY:360}),
    new ZombieCaminante('imagenes/zombie4.png',300,250,10,10,1,{desdeX: 300,hastaX: 550,desdeY: 250, hastaY:250}),
    new ZombieConductor('imagenes/tren_horizontal.png',0,325,90,30,5,{desdeX:0,hastaX:900,desdeY: 325, hastaY:325},'H'),
    new ZombieConductor('imagenes/tren_vertical.png',644,0,30,90,3,{desdeX:644,hastaX:644,desdeY: 0, hastaY:500},'V'),
    new ZombieConductor('imagenes/tren_vertical.png',674,0,30,90,7,{desdeX:674,hastaX:674,desdeY: 0, hastaY:500},'V')    
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  var sprite = this.jugador.sprite;
  var ancho = this.jugador.ancho;
  var alto = this.jugador.alto;
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y, sprite, ancho,alto)) {
    /* Aca tiene que estar la logica para mover al jugador invocando alguno
    de sus metodos  */
    var x = movX + this.jugador.x;
    var y = movY + this.jugador.y;
    
    /* COMPLETAR */
    Jugador.mover(x,y,ancho,alto,sprite);
  }
};
...
Juego.dibujar = function() {
  ...
  //dibujar llegada
  Dibujante.dibujarImagen('imagenes/llegada.png',758,470,130,40);
